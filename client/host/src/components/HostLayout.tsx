...
export default function HostLayout() {
    ...
    const navItems = [
        {
            path: '/host/dashboard', label: t.dashboard, icon: (
        ...
        {
            path: '/host/spots', label: t.mySpots, icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            path: '/host/bookings', label: t.bookings, icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            path: '/host/earnings', label: t.earnings, icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-4 border-t border-gray-800">
                    <div className="flex items-center gap-3 px-4 py-3 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500 truncate">{t.hostAccount}</p>
                        </div>
                    </div>
                    <a
                        href={HOME_URL}
