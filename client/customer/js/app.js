document.addEventListener('DOMContentLoaded', () => {
    ...
    const t = {
        en: {
            ...
            contact_hint: 'In case you need to be contacted.',
            vehicle_title: 'Vehicle information',
            vehicle_desc: 'Your vehicle registration number will be shared with the parking space owner/operator.',
            ph_vehicle_reg: 'Enter registration',
            payment_title: 'Payment information',
            payment_desc: 'All payments are secure and encrypted',
        ...
        vi: {
            ...
            details_title: 'Chi tiết đặt chỗ Parkchung',
            ...
            contact_title: 'Bắt đầu nhé',
            contact_phone_label: 'Số điện thoại',
            contact_hint: 'Trong trường hợp cần liên hệ với bạn.',
            vehicle_title: 'Thông tin phương tiện',
            vehicle_desc: 'Biển số sẽ được chia sẻ với chủ bãi/đơn vị vận hành.',
            ph_vehicle_reg: 'Nhập biển số',
            payment_title: 'Thông tin thanh toán',
            payment_desc: 'Mọi thanh toán đều được mã hóa và an toàn',
